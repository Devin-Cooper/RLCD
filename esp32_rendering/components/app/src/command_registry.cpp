...
const std::array<uint16_t, 33> kAllDispatchableIds = {
    ...
    cmd_id::SpeakerTest, cmd_id::MicTest, cmd_id::OpenFiles, cmd_id::NewFile,
...
void CommandRegistry::registerGlobals() {
    ...
    put(g[globals_count_++], "New file...",                       "", cmd_id::NewFile);
}

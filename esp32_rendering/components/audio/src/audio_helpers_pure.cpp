// Pure helpers split out of audio_helpers.cpp so they can be linked into
// host tests without dragging speaker.hpp's I²C/I²S transitive includes.
//
// Hardware-touching helpers (audio::beep) remain in audio_helpers.cpp.
